            ...
            <div class="box box-primary">
                ...
                <form class="">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="form-group d-flex col-lg-6" id="form-identity_card">
                                ...
                                <div>
                                    <input id="identity_card" name="identity_card" type="text" class="form-control" placeholder="CCCD/Mã định danh">
                                </div>
                            </div>
                            <div class="col-lg-12">
                    ...
                    <div class="box-footer">
                        <a href="javascript:void(0)" class="btn btn-primary add-user">Thêm</a>
                ...
                <form class="">
                    ...
                    <div class="box-body">
                        <div class="form-group d-flex" id="form-email">
                            ...
                            <div>
                                <input id="email" name="email" type="email" class="form-control" placeholder="Eamil đăng nhập">
                            </div>
                        </div>
                        <div class="form-group d-flex" id="form-password">
                            <label class="" for="password">Mật khẩu <span class="required-dot">**</span></label>
                            <div>
