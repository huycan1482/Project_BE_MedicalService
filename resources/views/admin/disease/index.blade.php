...
<section class="content">
    <div class="row">
        <div class="col-lg-12" style="margin-bottom: 10px">  
            <a class="btn btn-info" href="{{ route('admin.disease.create') }}">
                        ...
                        <tbody>
                            ...
                            <tr class="item-{{ $disease->id }}">
                                ...
                                <td class="text-center">
                                    ...
                                    @can('viewAny', App\User::class)
                                    <a href="javascript:void(0)" class="btn btn-danger" onclick="destroyModel('disease', '{{ $disease->id }}' )" title="Xóa">
                                        <i class="fa fa-trash"></i>
                                    </a>
                                    @endcan
