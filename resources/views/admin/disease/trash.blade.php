...
<section class="content-header">
    <h1>
        Quản lý danh sách Dịch bệnh đã xóa
        {{-- <small><a href="{{ route('admin.disease.create') }}">Thêm mới</a></small> --}}
    </h1>
</section>
...
<section class="content">
    <div class="row">
        <div class="col-lg-12" style="margin-bottom: 10px">  
            <div class="col-lg-12" style="margin-bottom: 10px">  
                <a class="btn btn-primary" href="{{ route('admin.disease.index') }}">
                        ...
                        <tbody>
                            ...
                            <tr class="item-{{ $disease->id }}">
                                ...
                                <td class="text-center">
                                    <span class="label label-{{ ($disease->is_active == 1) ? 'success' : 'danger' }}">{{ ($disease->is_active == 1) ? 'Hiển thị' : 'Ẩn' }}</span>
                                </td>
                                <td class="text-center">
                                    <a href="javascript:void(0)" onclick="restore('disease/restore', '{{ $disease->id }}' )" class="btn btn-primary" title="Khôi phục">
                                        <i class="fas fa-trash-restore"></i>
                                    </a>

                                    <a href="javascript:void(0)" onclick = "forceDelete('disease/forceDelete', '{{ $disease->id }}' )" class="btn btn-danger" title="Xóa">
...
<script src="/myAssets/js/disease/index.js"></script>
@endsection
