...
<section class="content-header">
    <h1>
        Quản lý danh sách Vaccine đã xóa
    </h1>
</section>
...
<section class="content">
    <div class="row">
        <div class="col-lg-12" style="margin-bottom: 10px">  
            <a class="btn btn-primary" href="{{ route('admin.vaccine.index') }}">
                        ...
                        <tbody>
                            ...
                            <tr class="item-{{ $vaccine->id }}">
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="javascript:void(0)" onclick="restore('vaccine/restore', '{{ $vaccine->id }}' )" class="btn btn-primary" title="Khôi phục">
                                        <i class="fas fa-trash-restore"></i>
                                    </a>

                                    <a href="javascript:void(0)" onclick = "forceDelete('vaccine/forceDelete', '{{ $vaccine->id }}' )" class="btn btn-danger" title="Xóa">
