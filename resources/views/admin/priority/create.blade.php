                ...
                <form class="">
                    ...
                    <div class="box-body">
                        <div class="form-group d-flex" id="form-name">
                            ...
                            <div>
                                <input id="name" name="name" type="text" class="form-control" placeholder="Tên nhóm đối tượng ưu tiên">
                            </div>
                        </div>
                    ...
                    <div class="box-footer">
                        <a href="javascript:void(0)" class="btn btn-primary add-priority">Thêm</a>
