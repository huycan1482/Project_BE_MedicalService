...
<section class="content-header">
    <h1> Quản lý danh sách Đối tượng ưu tiên đã xóa</h1>
</section>
...
<section class="content">
    ...
    <div class="row">    
        <div class="col-lg-12" style="margin-bottom: 10px">  
            <a class="btn btn-primary" href="{{ route('admin.priority.index') }}">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr data-id={{ $priority->id }}>
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" onclick="restore('priority/restore', '{{ $priority->id }}' )" class="btn btn-primary" title="Khôi phục">
                                        <i class="fas fa-trash-restore"></i>
                                    </a>

                                    <a href="javascript:void(0)" onclick = "forceDelete('priority/forceDelete', '{{ $priority->id }}' )" class="btn btn-danger" title="Xóa">
