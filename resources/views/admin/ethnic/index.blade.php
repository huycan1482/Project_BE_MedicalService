...
<section class="content-header">
    <h1> Quản lý danh sách Dân tộc </h1>
</section>
...
<section class="content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="custom-import">
                        <form action="{{ route('admin.import.ethnic') }}" method="POST" name="" enctype="multipart/form-data">
                            @csrf
    ...
    <div class="row">    
        <div class="col-lg-12" style="margin-bottom: 10px">  
            <a class="btn bg-purple" href="{{ route('admin.ethnic.create') }}">
                        ...
                        <tbody>
                            ...
                            <tr class="item-{{ $ethnic->id }}">
                                ...
                                <td class="text-center">
                                    <span class="label label-{{ ($ethnic->is_active == 1) ? 'success' : 'danger' }}">{{ ($ethnic->is_active == 1) ? 'Hiển thị' : 'Ẩn' }}</span>
                                </td>
                                <td class="text-center">
...
<script src="/myAssets/js/ethnic/index.js"></script>
@endsection
