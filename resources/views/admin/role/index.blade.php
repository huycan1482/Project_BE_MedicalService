...
<title>Medical Services | role</title>
@endsection
...
<section class="content">
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-bottom: 10px">  
            <a class="btn btn-info" href="{{ route('admin.role.create') }}">
                        ...
                        <tbody>
                            ...
                            <tr data-id={{ $role->id }}>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-danger" onclick="destroyModel('role', '{{ $role->id }}' )" title="Xóa">
