                ...
                <form class="">
                    ...
                    <div class="box-body">
                        <div class="form-group d-flex" id="form-name">
                            ...
                            <div>
                                <input id="name" name="name" type="text" class="form-control" placeholder="Tên Lô vaccine">
                            </div>
                        </div>
                        <div class="form-group d-flex" id="form-expired">
                            <label class="" for="expired">Hạn sử dụng</label>
                            <div>
                                <input id="expired" name="expired" type="date" class="form-control" placeholder="Hạn sử dụng">
                            </div>
                        </div>
                    ...
                    <div class="box-footer">
                        <a href="javascript:void(0)" class="btn btn-primary add-pack">Thêm</a>
