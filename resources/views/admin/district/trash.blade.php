...
<section class="content-header">
    <h1>
        Quản lý danh sách Quận/Huyện đã xóa
...
<section class="content">
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-bottom: 10px">  
            <a class="btn btn-primary" href="{{ route('admin.district.index') }}">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr class="item-{{ $district->id }}">
                                ...
                                <td class="">{{ $district->belongsToProvinceTrashed->name }}</td>
                                <td class="text-center">
                                    <span class="label label-{{ ($district->is_active == 1) ? 'success' : 'danger' }}">{{ ($district->is_active == 1) ? 'Hiển thị' : 'Ẩn' }}</span>
                                </td>
                                <td class="text-center">
                                    <a href="javascript:void(0)" onclick="restore('district/restore', '{{ $district->id }}' )" class="btn btn-primary" title="Khôi phục">
                                        <i class="fas fa-trash-restore"></i>
                                    </a>

                                    <a href="javascript:void(0)" onclick = "forceDelete('district/forceDelete', '{{ $district->id }}' )" class="btn btn-danger" title="Xóa">
