...
class DistrictRequest extends FormRequest
{
    ...
    */
    ...
    public function rules()
    {
        if ($this->district) {
            return [
                'name' => 'required|string:255|unique:districts,name,'.$this->district,
        ...
        return [
            'name' => 'required|string:255|unique:districts,name',
            'province_id' => 'required|exists:provinces,id',
            'is_active' => 'required|integer|min:0|max:1'
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'province_id.required' => 'Yêu cầu không để trống',
            'province_id.exists' => 'Dữ liệu không tồn tại',
